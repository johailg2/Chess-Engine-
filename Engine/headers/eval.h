...
public:
    ...
    SearchResult minMax(ChessBoard& board, int depth, int bestEvaluatedWhiteScore, 
                        int bestEvaluatedBlackScore, bool player, vector<Move>& pv);
    ...
    int kingSafety(const ChessBoard& board, bool isMiddleGame);
